...
class TBCNNEncoder(ASTEncoder):
  ...
  def _make_placeholders(self):
    ...
    #self.placeholders['node_type_ids'] = tf.placeholder(tf.int32, shape=[None, self.get_hyper('max_num_nodes')], name='node_type_ids')
    #self.placeholders['children'] = tf.placeholder(tf.int32, shape=(None, self.get_hyper('max_num_nodes'), self.get_hyper('max_num_children')), name='children')
